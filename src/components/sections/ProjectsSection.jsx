...
import { SectionTitle, Button, AnimatedElement, StaggerContainer, StaggerItem } from '../common';
import projectsData from '../../data/projects.json';

export default function ProjectsSection() {
    const featuredProjects = projectsData.projects.filter((p) => p.featured).slice(0, 4);
                            ...
                            <Link to={`/calismalar/${project.id}`}>
                                ...
                                >
                                    ...
                                    <div className="p-6">
                                        ...
                                        {/* Arrow indicator */}
                                        <motion.div
                                            className="absolute bottom-6 right-6 w-10 h-10 rounded-full bg-white/5 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300"
