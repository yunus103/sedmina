                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                    ...
                    <AnimatedElement animation="fadeUp">
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-display font-bold text-white mb-4 leading-tight">
                            Haydi birlikte{' '}
                            <span className="text-gradient">hayal edilemezi</span>{' '}
                            inşa edelim.
                        </h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-surface border border-white/10 rounded-xl px-4 py-3 text-white text-sm placeholder:text-text-muted focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all duration-300"
                                        required
                                    />
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows={5}
                                    className="w-full bg-surface border border-white/10 rounded-xl px-4 py-3 text-white text-sm placeholder:text-text-muted focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/20 transition-all duration-300 resize-none"
                                    required
                                />
                            </div>
                            ...
                            <motion.button
                                type="submit"
                                className="w-full bg-white text-background font-semibold py-4 rounded-xl text-sm tracking-wide hover:bg-primary hover:text-background transition-colors duration-300 flex items-center justify-center gap-2"
