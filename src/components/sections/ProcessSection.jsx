              ...
              >
                ...
                <div className="relative p-6 md:p-8 h-full min-h-[400px] md:min-h-[450px] flex flex-col justify-between">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <motion.div
                      className="w-8 h-8 rounded-full bg-text-primary/10 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                ...
                {!isActive && (
                  <div className="absolute inset-0 hidden md:flex items-center justify-center pointer-events-none">
                    <motion.span
                      className="text-4xl font-display font-bold text-text-primary/20 writing-vertical"
                      style={{
