...
export default function Card({
    ...
    return (
        <motion.div
            className={`
        relative bg-surface/80 backdrop-blur-md border border-white/5 rounded-2xl
        overflow-hidden
        ${hover ? 'transition-all duration-500 hover:bg-surface-light/80 hover:border-white/10' : ''}
        ${className}
      `}
