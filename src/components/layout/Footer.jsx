            ...
            <div className="container-custom section-padding">
                ...
                <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex gap-6">
                        <a href="/gizlilik" className="text-text-muted text-sm hover:text-primary transition-colors duration-300">
                            Gizlilik Politikası
                        </a>
                        <a href="/kullanim-sartlari" className="text-text-muted text-sm hover:text-primary transition-colors duration-300">
                            Kullanım Şartları
                        </a>
                    </div>
                </div>
