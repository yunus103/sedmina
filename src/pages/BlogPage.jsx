            ...
            <div className="container-custom">
                ...
                <AnimatedElement animation="fadeUp" className="mb-12 md:mb-16">
                    ...
                    <p className="text-text-secondary text-lg max-w-2xl leading-relaxed">
                        Dijital dünyadan en güncel trendler, stratejiler ve
                        ekibimizin uzmanlık alanlarından derinlemesine analizler.
                    </p>
                </AnimatedElement>
                            ...
                            {filteredPosts.map((post, index) => (
                                ...
                                >
                                    <Link to={`/blog/${post.id}`}>
                                        <motion.article
                                            className="group relative flex flex-col bg-surface rounded-2xl overflow-hidden border border-white/5 h-full cursor-pointer"
                ...
                {filteredPosts.length === 0 && (
                    <div className="text-center py-20">
                        <p className="text-text-secondary">Bu kategoride henüz yazı bulunmuyor.</p>
                    </div>
                )}
            </div>
        </div>
