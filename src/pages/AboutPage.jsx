...
import { ArrowRight, Users, Rocket, Award, Heart, Target, Zap } from 'lucide-react';
...
const values = [
    {
        ...
        description: 'Her projeye derinlemesine analiz ve veri odaklı stratejilerle yaklaşıyoruz.',
    },
    {
        icon: Zap,
        title: 'Yenilikçi Çözümler',
        description: 'En yeni teknolojileri kullanarak sınırları zorlayan dijital deneyimler tasarlıyoruz.',
    },
    {
        icon: Heart,
        title: 'Tutku & Özveri',
        description: 'Her projemize kendi markamızmış gibi tutkuyla ve özveriyle yaklaşıyoruz.',
    },
    {
        icon: Award,
        title: 'Kalite Odaklılık',
        description: 'En yüksek standartlarda çalışarak, mükemmeliyeti hedefliyoruz.',
    },
    {
        icon: Users,
        title: 'İşbirlikçi Yaklaşım',
        description: 'Müşterilerimizle şeffaf ve sürekli iletişim içinde çalışıyoruz.',
    },
    {
        icon: Rocket,
        title: 'Sonuç Odaklılık',
        description: 'Ölçülebilir sonuçlar üreten, ROI odaklı projeler geliştiriyoruz.',
    },
];
...
const timeline = [
    {
        year: '2021',
        title: 'Kuruluş',
        description: 'SedMina, dijital dünyada fark yaratma vizyonuyla İstanbul\'da kuruldu.',
    },
    {
        year: '2022',
        title: 'İlk Büyük Projeler',
        description: 'Kurumsal müşterilerle çalışmaya başlayarak portföyümüzü genişlettik.',
    },
    {
        year: '2023',
        title: 'Ekip Büyümesi',
        description: 'Alanında uzman yetenekleri ekibimize katarak kapasitemizi artırdık.',
    },
    {
        year: '2024',
    ...
    },
    {
        year: '2025',
        title: 'Yeni Ufuklar',
        description: 'AI destekli çözümler ve ileri teknolojilerle hizmet yelpazemizi genişletiyoruz.',
    },
];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    <AnimatedElement animation="fadeUp">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white mb-6 leading-tight">
                            Fikir ve Etki arasındaki{' '}
                            <span className="text-gradient">görünmeyen bağı</span>{' '}
                            işliyoruz.
                        </h1>
                        <p className="text-text-secondary text-lg leading-relaxed mb-8">
                            SedMina, dijital dünyada markaları öne çıkaran stratejik bir deneyim
                            stüdyosudur. Yaratıcılığı teknolojiyle, stratejiyi tasarımla
                            harmanlayarak unutulmaz dijital deneyimler yaratıyoruz.
                        </p>
