        ...
        <div className="pt-24 pb-20 min-h-screen bg-background">
            <div className="container-custom">
                            ...
                            post.content.map((block, index) => {
                                if (block.type === 'heading') {
                                    return (
                                        <motion.h2
                                            key={index}
                                            className="text-xl md:text-2xl font-display font-bold text-white mt-10 mb-4"
                ...
                <div className="max-w-3xl mx-auto mb-16">
                    <div className="flex items-center justify-between p-6 rounded-2xl bg-surface/50 border border-white/5">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-white text-sm font-medium">{post.type}</span>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {relatedPosts.map((related) => (
                                <Link to={`/blog/${related.id}`} key={related.id}>
                                    <motion.div
                                        className="group flex gap-4 p-4 rounded-xl bg-surface/50 border border-white/5 hover:border-primary/20 transition-all duration-300"
                                        whileHover={{ x: 4 }}
                                    >
                                        <div
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <span className="text-xs text-text-muted">{related.date}</span>
                                            <h4 className="text-white font-medium text-sm mt-1 group-hover:text-primary transition-colors duration-300 line-clamp-2">
                                                {related.title}
                                            </h4>
                                        </div>
                                    </motion.div>
                ...
                <AnimatedElement animation="fadeUp" className="max-w-4xl mx-auto mb-16">
                    <div className="relative rounded-2xl overflow-hidden p-8 md:p-12 bg-surface border border-white/5 text-center">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-text-secondary mb-6 max-w-lg mx-auto">
                                Dijital stratejinizi güçlendirmek için uzman ekibimizle iletişime geçin.
                            </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-4xl mx-auto">
                    {prevPost ? (
                        ...
                        >
                            ...
                            <div className="min-w-0">
                                <span className="text-text-muted text-xs uppercase tracking-wider">Önceki Yazı</span>
                    ...
                    {nextPost && (
                        ...
                        >
                            <div className="min-w-0">
                                <span className="text-text-muted text-xs uppercase tracking-wider">Sonraki Yazı</span>
                                <p className="text-white font-medium group-hover:text-primary transition-colors duration-300 line-clamp-1">
                                    {nextPost.title}
                                </p>
                            </div>
